...
export interface BackendProfitModalProps {
  open: boolean;
  onClose: () => void;
}

export default function BackendProfitModal({ open, onClose }: BackendProfitModalProps) {
      ...
      <FormModal
        ...
        headerIcon={
          <div className="flex h-12 w-12 items-center justify-center">
            <Image src="/User.png" alt="Backdated Profile And Loss Transfer" width={48} height={48} />
          </div>
        }
        tabs={[]}
        activeTab=""
