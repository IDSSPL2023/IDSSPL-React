...
import { User, FileText, Hash, MoreVertical, ThumbsUp, ThumbsDown, X, Landmark } from "lucide-react";
...
} from "@/components/HO-Clerk/AddReconciliation";

export interface AuthorizeReconciliationModalProps {
  open: boolean;
...
const AuthorizeReconciliationFooter = ({
  onReject,
  onCancel,
  onAuthorize,
}: {
...
const AuthorizeReconciliationModal = ({
  ...
  onAuthorize,
  onReject,
}: AuthorizeReconciliationModalProps) => {
      ...
      <FormModal
        ...
        headerIcon={
          <div className="flex h-12 w-12 items-center justify-center">
            <Image src="/Authorize User.png" alt="Authorize Reconciliation" width={50} height={50} />
          </div>
        }
        tabs={[]}
        activeTab=""
        ...
        maxWidth="max-w-7/8"
        customFooter={
          <AuthorizeReconciliationFooter onReject={handleReject} onCancel={onClose} onAuthorize={handleAuthorize} />
        }
      >
        <SectionCard
...
export default AuthorizeReconciliationModal;
