...
export type HoCashDepositFilters = Record<FilterKey, string>;

type HoCashDepositFilterModalProps = {
  onClose: () => void;
  onApply: (filters: HoCashDepositFilters) => void;
  initialValues?: HoCashDepositFilters;
};

export const defaultHoCashDepositFilters: HoCashDepositFilters = {
  accountName: "",
  accountCode: "",
  scrollNo: "",
};

export default function HoCashDepositFilterModal({
  onClose,
  onApply,
  initialValues = defaultHoCashDepositFilters,
}: HoCashDepositFilterModalProps) {
  const [activeFilter, setActiveFilter] = useState<FilterKey>("accountName");
  const [values, setValues] = useState<HoCashDepositFilters>(initialValues);
  ...
  const handleClearAll = () => {
    setValues(defaultHoCashDepositFilters);
    onApply(defaultHoCashDepositFilters);
    onClose();
  };
