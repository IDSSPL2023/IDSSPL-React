...
export type HoCashWithdrawalFilters = Record<FilterKey, string>;

type HoCashWithdrawalFilterModalProps = {
  onClose: () => void;
  onApply: (filters: HoCashWithdrawalFilters) => void;
  initialValues?: HoCashWithdrawalFilters;
};

export const defaultHoCashWithdrawalFilters: HoCashWithdrawalFilters = {
  accountName: "",
  accountCode: "",
  scrollNo: "",
};

export default function HoCashWithdrawalFilterModal({
  onClose,
  onApply,
  initialValues = defaultHoCashWithdrawalFilters,
}: HoCashWithdrawalFilterModalProps) {
  const [activeFilter, setActiveFilter] = useState<FilterKey>("accountName");
  const [values, setValues] = useState<HoCashWithdrawalFilters>(initialValues);
  ...
  const handleClearAll = () => {
    setValues(defaultHoCashWithdrawalFilters);
    onApply(defaultHoCashWithdrawalFilters);
    onClose();
  };
