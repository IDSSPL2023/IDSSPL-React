...
export type InvestmentPaymentClosingFilters = Record<FilterKey, string>;

type InvestmentPaymentClosingFilterModalProps = {
  onClose: () => void;
  onApply: (filters: InvestmentPaymentClosingFilters) => void;
  initialValues?: InvestmentPaymentClosingFilters;
};

export const defaultInvestmentPaymentClosingFilters: InvestmentPaymentClosingFilters = {
  accountName: "",
  accountCode: "",
  scrollNo: "",
};

export default function InvestmentPaymentClosingFilterModal({
  onClose,
  onApply,
  initialValues = defaultInvestmentPaymentClosingFilters,
}: InvestmentPaymentClosingFilterModalProps) {
  const [activeFilter, setActiveFilter] = useState<FilterKey>("accountName");
  const [values, setValues] = useState<InvestmentPaymentClosingFilters>(initialValues);
  ...
  const handleClearAll = () => {
    setValues(defaultInvestmentPaymentClosingFilters);
    onApply(defaultInvestmentPaymentClosingFilters);
    onClose();
  };
