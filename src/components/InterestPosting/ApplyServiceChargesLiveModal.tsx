...
export interface ApplyServiceChargesLiveModalProps {
  open: boolean;
  onClose: () => void;
...
export default function ApplyServiceChargesLiveModal({
  open,
  onClose,
  module,
}: ApplyServiceChargesLiveModalProps) {
    ...
    <>
      ...
      >
        <div className="grid w-full grid-cols-2 gap-x-10 gap-y-6">
          ...
          {/* No of Days */}
          <FieldWrap label="No of Days" labelHi="दिनांकपर्यंत" required>
            <input
              type="text"
              value={noOfDays}
