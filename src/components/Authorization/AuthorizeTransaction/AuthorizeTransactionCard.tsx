...
import type { AuthorizeTransactionItem } from "./authorizeTransactionData";

type AuthorizeTransactionCardProps = {
  item: AuthorizeTransactionItem;
  onOpen: (item: AuthorizeTransactionItem) => void;
};

const AuthorizeTransactionCard = ({ item, onOpen }: AuthorizeTransactionCardProps) => {
  return (
    <div
      role="button"
      tabIndex={0}
...
export default AuthorizeTransactionCard;
