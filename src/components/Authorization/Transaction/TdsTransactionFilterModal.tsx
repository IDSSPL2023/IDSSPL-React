...
export type TdsTransactionFilters = Record<FilterKey, string>;

type TdsTransactionFilterModalProps = {
  onClose: () => void;
  onApply: (filters: TdsTransactionFilters) => void;
  initialValues?: TdsTransactionFilters;
};

export const defaultTdsTransactionFilters: TdsTransactionFilters = {
  accountCode: "",
  scrollNo: "",
  amount: "",
  userId: "",
...
export default function TdsTransactionFilterModal({
  onClose,
  onApply,
  initialValues = defaultTdsTransactionFilters,
}: TdsTransactionFilterModalProps) {
  const [activeFilter, setActiveFilter] = useState<FilterKey>("accountCode");
  const [values, setValues] = useState<TdsTransactionFilters>(initialValues);
  ...
  const handleClearAll = () => {
    setValues(defaultTdsTransactionFilters);
    onApply(defaultTdsTransactionFilters);
    onClose();
  };
