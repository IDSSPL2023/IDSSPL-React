...
export type CashWithdrawalFilters = Record<FilterKey, string>;

type CashWithdrawalFilterModalProps = {
  onClose: () => void;
  onApply: (filters: CashWithdrawalFilters) => void;
  initialValues?: CashWithdrawalFilters;
};

export const defaultCashWithdrawalFilters: CashWithdrawalFilters = {
  accountName: "",
  accountCode: "",
  scrollNo: "",
  userId: "",
...
export default function CashWithdrawalFilterModal({
  onClose,
  onApply,
  initialValues = defaultCashWithdrawalFilters,
}: CashWithdrawalFilterModalProps) {
  const [activeFilter, setActiveFilter] = useState<FilterKey>("accountName");
  const [values, setValues] = useState<CashWithdrawalFilters>(initialValues);
  ...
  const handleClearAll = () => {
    setValues(defaultCashWithdrawalFilters);
    onApply(defaultCashWithdrawalFilters);
    onClose();
  };
