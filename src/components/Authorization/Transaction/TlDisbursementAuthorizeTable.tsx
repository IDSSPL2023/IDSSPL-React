...
import type { TlDisbursementFilters } from "./TlDisbursementFilterModal";

export type TlDisbursementAuthorizeTab = "new" | "rejected";

export type TlDisbursementAuthorizeRow = {
  srNo: number;
  scrollNo: string;
  accountCode: string;
  amount: string;
  ...
  createdBy: string;
  createdDate: string;
  tab: TlDisbursementAuthorizeTab;
};
...
const SAMPLE_DISBURSEMENTS: Omit<TlDisbursementAuthorizeRow, "srNo" | "tab">[] = [
...
const buildRows = (tab: TlDisbursementAuthorizeTab, count: number): TlDisbursementAuthorizeRow[] =>
  Array.from({ length: count }, (_, i) => ({
    ...SAMPLE_DISBURSEMENTS[i % SAMPLE_DISBURSEMENTS.length],
    scrollNo: String(118 + i + (tab === "rejected" ? 100 : 0)),
    srNo: i + 1,
    tab,
  }));

export const TL_DISBURSEMENT_TAB_COUNTS: Record<TlDisbursementAuthorizeTab, number> = {
  new: 20,
  rejected: 18,
};

const ALL_ROWS: TlDisbursementAuthorizeRow[] = [
  ...buildRows("new", TL_DISBURSEMENT_TAB_COUNTS.new),
  ...buildRows("rejected", TL_DISBURSEMENT_TAB_COUNTS.rejected),
];
...
type TlDisbursementAuthorizeTableProps = {
  activeTab: TlDisbursementAuthorizeTab;
  filters?: TlDisbursementFilters;
  onAuthorize?: (row: TlDisbursementAuthorizeRow) => void;
};

const TlDisbursementAuthorizeTable = ({ activeTab, filters, onAuthorize }: TlDisbursementAuthorizeTableProps) => {
...
export default TlDisbursementAuthorizeTable;
