...
export type TlDisbursementFilters = Record<FilterKey, string>;

type TlDisbursementFilterModalProps = {
  onClose: () => void;
  onApply: (filters: TlDisbursementFilters) => void;
  initialValues?: TlDisbursementFilters;
};

export const defaultTlDisbursementFilters: TlDisbursementFilters = {
  accountCode: "",
  scrollNo: "",
  amount: "",
  userId: "",
...
export default function TlDisbursementFilterModal({
  onClose,
  onApply,
  initialValues = defaultTlDisbursementFilters,
}: TlDisbursementFilterModalProps) {
  const [activeFilter, setActiveFilter] = useState<FilterKey>("accountCode");
  const [values, setValues] = useState<TlDisbursementFilters>(initialValues);
  ...
  const handleClearAll = () => {
    setValues(defaultTlDisbursementFilters);
    onApply(defaultTlDisbursementFilters);
    onClose();
  };
