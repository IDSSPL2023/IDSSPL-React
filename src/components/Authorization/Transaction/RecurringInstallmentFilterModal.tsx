...
export type RecurringInstallmentFilters = Record<FilterKey, string>;

type RecurringInstallmentFilterModalProps = {
  onClose: () => void;
  onApply: (filters: RecurringInstallmentFilters) => void;
  initialValues?: RecurringInstallmentFilters;
};

export const defaultRecurringInstallmentFilters: RecurringInstallmentFilters = {
  accountName: "",
  accountCode: "",
  scrollNo: "",
};

export default function RecurringInstallmentFilterModal({
  onClose,
  onApply,
  initialValues = defaultRecurringInstallmentFilters,
}: RecurringInstallmentFilterModalProps) {
  const [activeFilter, setActiveFilter] = useState<FilterKey>("accountName");
  const [values, setValues] = useState<RecurringInstallmentFilters>(initialValues);
  ...
  const handleClearAll = () => {
    setValues(defaultRecurringInstallmentFilters);
    onApply(defaultRecurringInstallmentFilters);
    onClose();
  };
