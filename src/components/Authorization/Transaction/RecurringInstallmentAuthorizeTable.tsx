...
import type { RecurringInstallmentFilters } from "./RecurringInstallmentFilterModal";

export type RecurringInstallmentAuthorizeTab = "new" | "modify" | "rejected";

export type RecurringInstallmentAuthorizeRow = {
  srNo: number;
  scrollNo: string;
  accountCode: string;
  accountName: string;
  ...
  createdBy: string;
  createdDate: string;
  tab: RecurringInstallmentAuthorizeTab;
};
...
const SAMPLE_INSTALLMENTS: Omit<RecurringInstallmentAuthorizeRow, "srNo" | "tab">[] = [
...
const buildRows = (tab: RecurringInstallmentAuthorizeTab, count: number): RecurringInstallmentAuthorizeRow[] =>
...
export const RECURRING_INSTALLMENT_TAB_COUNTS: Record<RecurringInstallmentAuthorizeTab, number> = {
  new: 20,
  modify: 18,
  rejected: 18,
};

const ALL_ROWS: RecurringInstallmentAuthorizeRow[] = [
  ...buildRows("new", RECURRING_INSTALLMENT_TAB_COUNTS.new),
  ...buildRows("modify", RECURRING_INSTALLMENT_TAB_COUNTS.modify),
  ...buildRows("rejected", RECURRING_INSTALLMENT_TAB_COUNTS.rejected),
];
...
type RecurringInstallmentAuthorizeTableProps = {
  activeTab: RecurringInstallmentAuthorizeTab;
  filters?: RecurringInstallmentFilters;
  onAuthorize?: (row: RecurringInstallmentAuthorizeRow) => void;
};

const RecurringInstallmentAuthorizeTable = ({ activeTab, filters, onAuthorize }: RecurringInstallmentAuthorizeTableProps) => {
...
export default RecurringInstallmentAuthorizeTable;
