...
const HeadOfficeMasterPage: React.FC<HeadOfficeMasterPageProps> = ({ initialMasterKey }) => {
  ...
  const handleOpenMaster = useCallback(
    ...
    [loadClearingTypes, loadProducts, loadTdInterestRates, loadInstallmentTypes, loadInstrumentTypes]
  );

  // Handle initial master key
  useEffect(() => {
