...
import { User, CreditCard, IndianRupee, FileText, Hash, Percent, Building2, Landmark, MoreVertical, ThumbsUp, ThumbsDown, X, Calendar, Clock, CheckCircle, AlertCircle } from "lucide-react";
...
import TdInterestPaymentAuthorizeTable, { type TdInterestPaymentAuthorizeRow } from "@/components/Authorization/Transaction/TdInterestPaymentAuthorizeTable";
import TdInterestPaymentFilterModal, { defaultTdInterestPaymentFilters, type TdInterestPaymentFilters } from "@/components/Authorization/Transaction/TdInterestPaymentFilterModal";
import { hasActiveFilters, getActiveFilterSummary } from "@/components/shared/filterSummary";

/* ===== from TermDepositDetailsModal.tsx ===== */
export interface TermDepositDetailsModal_TermDepositDetailModalProps {
  open: boolean;
...
const TermDepositDetailsModal_MODE_OF_PAYMENT_OPTIONS = ["Cash", "Transfer", "Cheque"];

const TermDepositDetailsModal_SectionIcon = () => (
  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary-100">
    <User size={20} className="text-primary" />
  </div>
);

const TermDepositDetailsModal_DisabledLookupTrigger = () => (
  <button
    type="button"
    disabled
    aria-hidden
...
const TermDepositDetailsModal_TermDepositDetailFooter = ({
  mode,
  onReject,
  onCancel,
  onAuthorize,
...
const TermDepositDetailModal = ({
  ...
  onReject,
  onEdit,
}: TermDepositDetailsModal_TermDepositDetailModalProps) => {
    ...
    <>
      <FormModal
        ...
        headerIcon={
          <div className="flex h-12 w-12 items-center justify-center">
            <Image src={IMAGES.AUTHORIZE_USER} alt="Term Deposit Interest Payment" width={50} height={50} />
          </div>
        }
        tabs={[]}
        activeTab=""
        ...
        maxWidth="max-w-7/8"
        customFooter={
          <TermDepositDetailsModal_TermDepositDetailFooter
            mode={mode}
      ...
      >
        ...
        <SectionCard
          ...
          icon={<TermDepositDetailsModal_SectionIcon />}
        >
          <div className={`${grid4} mt-2`}>
            ...
            <FieldShell label="Account Code" labelHi="खाते कोड" required>
              <div className="flex items-center gap-2">
                ...
                {isReadOnly ? <TermDepositDetailsModal_DisabledLookupTrigger /> : null}
              </div>
            </FieldShell>
          ...
          <div className={`${grid4} mt-2`}>
            <FieldShell label="Mode Of Payment" labelHi="देयक पद्धत" required>
              <SelectInput
                ...
                onChange={() => {}}
                options={TermDepositDetailsModal_MODE_OF_PAYMENT_OPTIONS}
                // disabled={isReadOnly}
              />
            </FieldShell>
...
/* ===== from TermDepositInterestPayment.tsx ===== */
